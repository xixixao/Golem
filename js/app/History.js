define(function() {
  ...
  return History = (function() {
    ...
    insert = function(text, from, to, what) {
      var appended, curr, newLines, oldLines, singleLine, _ref;
      ...
      if (newLines > 2 || oldLines > 2) {
        ...
        return ([].splice.apply(text, [(_ref = from.line + 1), Math.max(0, oldLines - newLines) - _ref].concat(appended)), appended);
      }
    };
