...
module.exports = CommandMode = (function(_super) {
  ...
  CommandMode.prototype.disableSuper = function() {
    ...
    this.editor.moveCursorToPosition({
      row: 0,
      column: this.getValue().length
    });
    this.editor.commands.removeCommands(this.commands);
    return this.isSuperDisabled = true;
  };

  CommandMode.prototype.enableSuper = function() {
    this.addCommands();
    return this.isSuperDisabled = false;
  };
  ...
  CommandMode.prototype.parseOnlyWorker = function(isTopLevel) {
    return this.worker.call('parseOnly', [isTopLevel]);
  };
