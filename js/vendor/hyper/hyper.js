...
module.exports = function (classDeclaration) {
  ...
  return React.createFactory(React.createClass(classDeclaration.prototype));
};
module.exports.render = function (node, factory) {
  return React.render(React.createElement(factory.type), node);
};
domWrapper = function (tag) {
  return function () {
    ...
    if (typeof attributes === "object" && !Array.isArray(attributes) && !React.isValidElement(attributes)) {
