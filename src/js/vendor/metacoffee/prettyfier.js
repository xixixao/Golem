...
define('js-beautify',[],function () {
  if (__isNode) {
  return __nodeRequire('js-beautify');
} else {
  return (typeof js_beautify !== 'undefined') ? js_beautify : __nodeRequire('js-beautify')
}
});
// Generated by uRequire v0.6.10 - template: 'combined' 
// Combined template optimized with RequireJS/r.js v2.1.4 & almond.
...
define('../errorhandler',"almond",[], function(){});
...
if (__isAMD) {
  return define('../errorhandler',bundleFactory);
} else {
    if (__isNode) {
...
define('prettyfier',['require', 'exports', 'module', 'js-beautify', '../errorhandler'], function (require, exports, module) {
